...
<head>
    ...
    <title>Pro Evolution Soccer 2020 - Game Detail</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    ...
    <section>
        <div class="game-detail-container">
            <img src="https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/Pro_Evolution_Soccer_2020.jpg/220px-Pro_Evolution_Soccer_2020.jpg" alt="Pro Evolution Soccer 2020" class="game-detail-image">
            <h2>Pro Evolution Soccer 2020</h2>
            <p><strong>Developer:</strong> Konami</p>
            <p><strong>Publisher:</strong> Konami</p>
            <p><strong>Release Date:</strong> September 10, 2019</p>
            <p><strong>Genre:</strong> Sports</p>
            <p>Experience realistic football action with Pro Evolution Soccer 2020. Enjoy enhanced gameplay and a range of features that bring the beautiful game to life.</p>
            ...
            <div>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/pTjfsYhvD7A" frameborder="0" allowfullscreen></iframe>
            </div>
