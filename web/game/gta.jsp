...
<head>
    ...
    <title>Grand Theft Auto V - Game Detail</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    ...
    <section>
        <div class="game-detail-container">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSx4E5VeiGZwu7lDvvyS7mY2eC0S79sdNiPsA&s" alt="Grand Theft Auto V" class="game-detail-image">
            <h2>Grand Theft Auto V</h2>
            <p><strong>Developer:</strong> Rockstar Games</p>
            <p><strong>Publisher:</strong> Rockstar Games</p>
            <p><strong>Release Date:</strong> September 17, 2013</p>
            <p><strong>Genre:</strong> Action-Adventure</p>
            <p>Experience the thrill of Los Santos with Grand Theft Auto V. Dive into an expansive open world with a gripping storyline and diverse gameplay.</p>
